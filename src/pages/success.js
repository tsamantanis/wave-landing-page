...
import Celebration from '../assets/img/celebration.inline.svg'
    ...
    return (
        <Layout>
            <div className="Landing">
                ...
                <div className="EarlyAccessSuccess">
                    <h3>We are glad to have you on board</h3>
                    <Celebration />
                    <a href="https://stories.freepik.com/event">Illustration by Freepik Stories</a>
                </div>
